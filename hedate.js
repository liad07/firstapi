...
if (window.location.href.indexOf("?convert") != -1) {
    var year = window.location.href.substring(window.location.href.indexOf("?year=")+6,window.location.href.indexOf("?month="));
    var month = window.location.href.substring(window.location.href.indexOf("?month=")+7,window.location.href.indexOf("?day="));
    var day = window.location.href.substring(window.location.href.indexOf("?day=")+5);
    year=parseInt(year);
    console.log(hebyear(year))
    console.log(month)
    console.log(heday(day-2))
    document.getElementById("2").style.display="none";
    document.getElementById("3").style.display="none";
    document.write('{"year":'+hebyear(year)+' "month":'+hemouth(month)+' "day":'+heday(day-2)+"}");
} else {
